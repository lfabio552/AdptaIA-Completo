      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '50px' }}>
          <div style={{ 
             ...
             background: 'linear-gradient(135deg, #10b981 0%, #047857 100%)', // Verde Excel
        ...
        <div style={{ 
          ...
          <div style={{ 
            backgroundColor: '#1f2937', 
            borderRadius: '20px', 
            border: '1px solid #10b981', // <--- CORREÇÃO AQUI: Borda Verde Neon fixa
            display: 'flex',
            flexDirection: 'column',
            minHeight: '450px',
            position: 'relative',
            ...
            {/* Visual de "Tabela" no fundo (Decorativo) */}
            <div style={{ 
            ...
            <div style={{ position: 'relative', zIndex: 1, flexGrow: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px', textAlign: 'center' }}>
                ...
                {isSuccess && (
                    <div style={{ animation: 'popIn 0.5s ease' }}>
                        ...
                        <div style={{ backgroundColor: '#111827', padding: '20px', borderRadius: '12px', border: '1px solid #059669', display: 'inline-block', minWidth: '250px' }}>
